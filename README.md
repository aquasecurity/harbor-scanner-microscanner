...
See [Scanner Adapters Architecture Proposal][scanner-adapter-architecture] for more details.
...
| `SCANNER_MICROSCANNER_OPTIONS`  | `--continue-on-failure`  | Additional options passed are arg to MicroScanner CLI     |
...
[scanner-adapter-architecture]: https://github.com/goharbor/community/pull/90
